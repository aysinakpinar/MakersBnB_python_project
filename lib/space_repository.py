...
class SpaceRepository:
    ...
    def add_space(self, space):
        self.connection.execute("INSERT INTO spaces\
                                (space_name, space_address, space_description, space_price, space_lister_id, space_active, space_image_path)\
                                VALUES(%s, %s, %s, %s, %s, %s, %s)", [space.name, space.address, space.description, space.price, space.lister_id, space.active, space.path])
